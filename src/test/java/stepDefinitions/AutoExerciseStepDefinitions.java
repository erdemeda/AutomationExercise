...
public class AutoExerciseStepDefinitions {
    ...
    public void kullaniciAnasayfasinda(String autoExerciseUrl) {
    ...
    public void gecerli_name_ve_email_address_girer() {
        ...
        autoExercisePage.emailTextBox.sendKeys("abc0@hotmail.com");
    }
...
//TestCase14
    ...
    public void your_order_has_been_placed_successfully_yazisinin_gorunur_oldugunu_test_eder() throws InterruptedException {
        Thread.sleep(2000);
